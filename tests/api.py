...
def room():
    ...
    obj = irucapy.room.from_json_maybe(valid_room_json_text)
    assert obj == irucapy.room.Room(
        id=1,
    ...
    obj = irucapy.room.from_json_maybe(insufficient_room_json_text)
    assert obj is None
    ...
    obj = irucapy.room.from_json_maybe(excessive_room_json_text)
    assert obj is None
...
def member():
    ...
    obj = irucapy.member.from_json_maybe(valid_member_json_text)
    assert obj == irucapy.member.Member(
        id=10000,
        room_id=1,
        name="Mya-Mya",
        status="B",
    ...
    obj = irucapy.member.from_json_maybe(insufficient_member_json_text)
    assert obj is None
    ...
    obj = irucapy.member.from_json_maybe(excessive_member_json_text)
    assert obj is None
...
def members():
    ...
    valid_members_json_text =\
        ...
        ']'
    obj = irucapy.members.from_json_maybe(valid_members_json_text)
    assert obj == [
        irucapy.member.Member(
            id=10000,
            room_id=1,
            name="Mya-Mya",
            status="B",
